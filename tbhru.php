...
$kode = mysqli_query($conn, "SELECT max(kode) as kodemaksimal FROM tblbarang");
$datakode = mysqli_fetch_array($kode);
$kodebarang = $datakode['kodemaksimal'];
...
$kodeBarang = $huruf . sprintf("%03s", $urutan);
    ...
    if(isset($_POST['submit'])) {
      ...
      $inst = mysqli_query($conn, "INSERT INTO tblbarang VALUES 
      (NULL,'$kode',$jbarang,$merk,'$tipe','$spek',
      '$noinv','$thnperolehan',$kondisi,'$fotob','$ruang',NULL,'$user','$ket'
      ) 
      ");
...
<br>
  ...
  <div class="form-group">
    ...
    <input type="text" name="kode" class="form-control" placeholder="Kode Barang" value="<?= $kodeBarang; ?>">
  </div>
